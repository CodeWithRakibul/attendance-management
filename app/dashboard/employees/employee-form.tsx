...
import { EmployeeFormData, employeeTypes, employeeStatuses } from '@/types/employee';
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div className='space-y-2'>
                    ...
                    <Select
                        value={formData.type}
                        onValueChange={(value) =>
                            handleInputChange('type', value as EmployeeFormData['type'])
                        }
                    >
                        <SelectTrigger>
                ...
                <div className='space-y-2'>
                    ...
                    <Select
                        ...
                        onValueChange={(value) =>
                            handleInputChange('status', value as EmployeeFormData['status'])
                        }
                    >
                        <SelectTrigger>
