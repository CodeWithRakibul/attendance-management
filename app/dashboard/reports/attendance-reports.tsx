                    ...
                    <div className='grid gap-4 sm:gap-6 md:grid-cols-4'>
                        ...
                        <div className='space-y-2'>
                            ...
                            <Select
                                ...
                                onValueChange={(value) =>
                                    setFilters({ ...filters, attendanceType: value })
                                }
                            >
                                <SelectTrigger className='w-full'>
                        ...
                        {/* Date Range Filters */}
                        {(filters.reportType === 'daily-summary' ||
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className='space-y-6'>
                                ...
                                <div className='border rounded-lg overflow-hidden'>
                                    <div className='bg-muted p-4'>
                                        <h4 className='font-medium'>
                                            Sample Attendance Records (First 10 records)
                                        </h4>
                                    </div>
                            ...
                            {/* Class-wise Summary */}
                            {filters.reportType === 'class-wise-summary' &&
