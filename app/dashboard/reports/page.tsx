      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Generate and export comprehensive reports for students, attendance, and finances
          </p>
        </div>
      </div>
              ...
              >
                <div className="flex items-center space-x-4">
                  <div className="flex-shrink-0">
                    {report.type === 'Student' && <Users className="h-5 w-5 text-blue-500" />}
                    {report.type === 'Attendance' && <Calendar className="h-5 w-5 text-green-500" />}
                    {report.type === 'Finance' && <DollarSign className="h-5 w-5 text-yellow-500" />}
                  </div>
                  <div>
