...
import { Student, StudentTableData } from '@/types/student';
                            ...
                            return (
                                <>
                                    <Avatar className='h-12 w-12'>
                                        <AvatarImage
                                            src={photoUrl || `/api/placeholder/150/150`}
                                            alt={nameEn}
                                        />
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                        ...
                        <CardContent className='space-y-4'>
                            <div className='grid grid-cols-2 gap-4'>
                                <div>
                                    ...
                                    <p className='text-sm'>
                                        {student.session?.year || 'Not assigned'}
                                    </p>
                                </div>
                                <div>
                                    <label className='text-sm font-medium text-muted-foreground'>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                <div>
                                    ...
                                    <p className='text-sm'>{student.roll || 'Not assigned'}</p>
                                </div>
                                <div>
                                    <label className='text-sm font-medium text-muted-foreground'>
                                        Registration Number
                    ...
                    <Card>
                        ...
                        <CardContent className='space-y-4'>
                            {(() => {
                                const guardian = student.guardian as any;
                                const fatherOccupation = guardian?.fatherOccupation;
                                const motherOccupation = guardian?.motherOccupation;
                                            ...
                                            {student.notes.map((note, index) => (
                                                ...
                                                >
                                                    ...
                                                    <p className='text-xs text-muted-foreground mt-1'>
                                                        By{' '}
                                                        {(note.staff.personal as any)?.nameEn ||
                                                            'Staff'}{' '}
                                                        on {formatDate(note.createdAt)}
                                                    </p>
                                                </div>
                                            ))}
                                        </div>
